...
def write_report(
    ...
    if getattr(args, "dynamic_params", False):
        lines.extend(
            [
                f"- Hot profile: score>={args.hot_min_score:.1f}, gap<={args.hot_max_gap_up:.1%}, value_ratio>={args.hot_gap_volume_min_ratio:.2f}, range5<={args.hot_max_5d_range_pct:.1f}, momentum10<={args.hot_max_momentum_10d_pct:.1f}, pos20<={args.hot_max_close_position_20d_pct:.1f}",
                f"- Normal profile: score>={args.normal_min_score:.1f}, gap<={args.normal_max_gap_up:.1%}, value_ratio>={args.normal_gap_volume_min_ratio:.2f}, range5<={args.normal_max_5d_range_pct:.1f}, momentum10<={args.normal_max_momentum_10d_pct:.1f}, pos20<={args.normal_max_close_position_20d_pct:.1f}",
                f"- Narrow rally profile: score>={args.narrow_rally_min_score:.1f}, gap<={args.narrow_rally_max_gap_up:.1%}, value_ratio>={args.narrow_rally_gap_volume_min_ratio:.2f}, range5<={args.narrow_rally_max_5d_range_pct:.1f}, momentum10<={args.narrow_rally_max_momentum_10d_pct:.1f}, pos20<={args.narrow_rally_max_close_position_20d_pct:.1f}",
                f"- Cold profile: score>={args.cold_min_score:.1f}, gap<={args.cold_max_gap_up:.1%}, value_ratio>={args.cold_gap_volume_min_ratio:.2f}, range5<={args.cold_max_5d_range_pct:.1f}, momentum10<={args.cold_max_momentum_10d_pct:.1f}, pos20<={args.cold_max_close_position_20d_pct:.1f}",
            ]
        )
    lines.extend(
        [
